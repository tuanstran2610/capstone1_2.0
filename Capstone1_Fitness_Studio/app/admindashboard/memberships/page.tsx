                  ...
                  filteredMemberships.map((m) => (
                    <tr key={m._id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${m.status === "active"
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                        {new Date(m.expiredDate).toLocaleDateString()}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end space-x-2">
                          <select
                            className="border border-primary-100 bg-primary-200 text-gray-300 rounded-md px-2 py-1 text-sm"
                            value={m.status}
                          ...
                          <button
                            ...
                            title="Update"
                            onClick={() => updateStatus(m._id, m.status)}
                          >
